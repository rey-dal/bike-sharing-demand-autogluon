...
## Overview
In this project, students will apply the knowledge and methods they learned in the AWS Machine Learning course to compete in a Kaggle competition using the AutoGluon library.
